PROGMEM iconButton homeNotificationsButton =   { 128, 32, 32, 32, INTERFACE_COLOR, BACKGROUND_COLOR,
  { (0b00100001 << 8) | 0b10000100,
    (0b01000111 << 8) | 0b11100010,
    (0b10001100 << 8) | 0b00110001,
    (0b10011000 << 8) | 0b00011001,
    (0b10010000 << 8) | 0b00001001,
    (0b00110000 << 8) | 0b00001100,
    (0b00110000 << 8) | 0b00001100,
    (0b00110000 << 8) | 0b00001100,
    (0b00110000 << 8) | 0b00001100,
    (0b00110000 << 8) | 0b00001100,
    (0b00100000 << 8) | 0b00000100,
    (0b01100000 << 8) | 0b00000110,
...
PROGMEM iconButton homeSettingsButton =   { 128, 64, 32, 32, INTERFACE_COLOR, BACKGROUND_COLOR,
  {
    (0b00000000 << 8) | 0b00001110,
    (0b00000000 << 8) | 0b00011111,
    (0b11111111 << 8) | 0b11011111,
    (0b11111111 << 8) | 0b11011111,
    (0b00000000 << 8) | 0b00001110,
    (0b00001100 << 8) | 0b00000000,
    (0b11011111 << 8) | 0b01111111,
    (0b11011111 << 8) | 0b01111111,
    (0b00011111 << 8) | 0b00000000,
    (0b00001110 << 8) | 0b00001110,
    (0b00000000 << 8) | 0b00011111,
    (0b11111111 << 8) | 0b11011111,
    (0b11111111 << 8) | 0b11011111,
    (0b00000000 << 8) | 0b00001110,
...
void HomeTouchHandler(int x, int y) {
  if (checkButtonPress(homeNotificationsButton, x, y) ) {
    pressButton(homeNotificationsButton);
    switchToNotifications();
  }
  if (checkButtonPress(homeSettingsButton, x, y) ) {
